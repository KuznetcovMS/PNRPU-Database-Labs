...
<body align="center">
    ...
    <br>
    <p><big>Ключевое слово INSERT используется для добавления новых записей в таблицу.
    </big></p>
    
    <form name="CREATE query" action="qExec.php" method="post"> 
        <label>Запрос: </label><br>
        <textarea cols="75" rows="10" name="query">INSERT INTO aircraft (id, Модель, Конструктор, ГодыПроизводства, КолВыпШтук)
        VALUES ('1', 'ТУ 154', 'Туполев', '1968-2013', '1026');
        </textarea>
        <br>
