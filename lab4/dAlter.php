...
<body align="center">
    ...
    <br>
    <p><big>Ключевое слово ALTER используется для добавления, удаления и изменения столбцов в таблице.
    </big></p>
    
    <form name="CREATE query" action="qExec.php" method="post"> 
        <label>Запрос: </label><br>
        <textarea cols="40" rows="10" name="query">ALTER TABLE c_employees
